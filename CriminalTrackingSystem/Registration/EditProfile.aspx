            ...
            <div class="edit-box">
                <div class="edit-item">
                    <div>
                        ...
                        <asp:Label Text="Pincode" runat="server" CssClass="fw-bolder" />
                        <asp:TextBox runat="server" ID="pin" class="cc-box" />
                    </div>
                    <div>
                        <i class="fa-solid fa-venus-mars"></i>
                        <asp:Label Text="Gender" runat="server" CssClass="fw-bolder" />
                ...
                <div class="edit-item">
                    <div>
                        ...
                        <asp:Label Text="Marital Status" runat="server" CssClass="fw-bolder" />
                    ...
                    <div>
                        ...
                        <asp:Label Text="Living Status" runat="server" CssClass="fw-bolder" />
                    ...
                    <div>
                        ...
                        <asp:Label Text="Adhaar Number" runat="server" CssClass="fw-bolder" />
                ...
                <div class="edit-item">
                    <div>
                        ...
                        <asp:Label Text="Email" runat="server" CssClass="fw-bolder" />
                        <asp:TextBox runat="server" ID="email" TextMode="Email" class="cc-box" />
                    </div>
                    <div>
                        <i class="fa-solid fa-location-dot"></i>
                        <asp:Label Text="Address" runat="server" CssClass="fw-bolder" />
                        <asp:TextBox runat="server" ID="address" class="cc-box" />
                    </div>
                    <div>
                        <i class="fa-solid fa-phone"></i>
                        <asp:Label Text="Phone" runat="server" CssClass="fw-bolder" />
                ...
                <div class="edit-item">
                    <div>
                        ...
                        <asp:Label Text="Profile Picture" runat="server" CssClass="fw-bolder" />
