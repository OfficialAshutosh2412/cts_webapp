    ...
    <div class="newspage">
        <div class="leftnews">
            ...
            <div class="marqueestyle">
                    <asp:GridView ID="GridView1" CssClass="w-100 table table-dark table-group-divider" runat="server" AutoGenerateColumns="False" DataKeyNames="Nid" DataSourceID="SqlDataSource1">
                    <Columns>
        ...
        <div class="rightnews">
            <div class="policeItem">
                <div>
                    <strong><asp:Label Text="find using title" runat="server" /></strong>
                ...
                <div>
                    <strong> <asp:Label Text="find using date" runat="server" /></strong>
                ...
                <div>
                    <strong><asp:Label Text="find using id" runat="server" /></strong>
            ...
            <div class="p-3">
                ...
                <small>
                    <strong><asp:Label Text="Date: " runat="server" /></strong>
                    <asp:Label runat="server" ID="date" /></small><br />
                <hr />
                <strong>
                    <asp:Label Text="Title: " runat="server" />
                </strong><asp:Label  runat="server" ID="title" />
                <br />
                <hr />
                <div>
                    <strong><asp:Label Text="Details: " runat="server" /></strong>
